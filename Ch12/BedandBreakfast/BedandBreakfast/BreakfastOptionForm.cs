...
namespace BedandBreakfast
{
    public partial class BreakfastOptionForm : Form
    {
        ...
        {
            Pricelbl.Text = "Price: " + CONT_BREAKFAST_PRICE.ToString("C");
        }
        ...
        {
            Pricelbl.Text = "Price: " + FULL_BREAKFAST_PRICE.ToString("C");
        }

        private void DeluxeRadioButton_CheckedChanged(object sender, EventArgs e)
        {
            Pricelbl.Text = "Price: " + DELUXE_BREAKFAST_PRICE.ToString("C");
        }
    }
}
